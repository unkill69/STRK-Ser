...
const approvalFunctionName = ["exactInputSingle", "exactOutputSingle", "supply"]
...
export default function AppPage() {
  ...
  return (
    <div className=" flex items-center flex-col gap-8 justify-start min-h-[90vh] py-20 max-w-7xl mx-auto rounded-xl">
      <div className=" w-full max-w-4xl flex items-end gap-3">
        <Label className="w-full space-y-2">
          <span className=" text-base">Your intentions, Ser 👀</span>
          <div className=" relative">
            <Input
              value={intent}
              onChange={(e) => setIntent(e.target.value)}
              placeholder="Send 100 STRK to 0xAD14E2F920F1aF86F85D2c08F2FDf71254317B096"
        ...
        <Button
          className="py-0 h-10 mb-0.5 flex items-center gap-2 outline"
